...
public class BluetoothTextingActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetooth_texting);
    ...
    private void setupListView() {
        aa = new ArrayAdapter<BluetoothDevice>(this,
                ...
                foundDevices);
        list = (ListView) findViewById(R.id.discovered_list);
        list.setAdapter(aa);
